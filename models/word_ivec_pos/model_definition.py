...
class WordPOSPredictor():
    ...
    def add_embeddings(self, session):
        ...
        ivec_embeddings_lookup = tf.nn.embedding_lookup(self.ivec_embedding_placeholder, self.ivec_inputs_placeholder)
        ivec_embeddings = tf.cast(tf.reshape(ivec_embeddings_lookup, (-1, ivec_max_seq_len, ivec_embedding_dim)), tf.float64)
